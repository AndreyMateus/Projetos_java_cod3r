...
public class DesafioFilter2 {
    public static void main(String[] args) {
        ...
        produtos.stream().filter(superPromocao).filter(freteGratis).filter(precoRelevante).map(chamadaPromocional).forEach(System.out::println);//o forEach pode ser usado em um contexto mais realista, como mandar os dados para o banco de dados ou mesmo transferir os dados para um JSON
