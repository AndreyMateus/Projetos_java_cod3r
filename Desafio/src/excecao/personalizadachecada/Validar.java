package excecao.personalizadachecada;
...
public class Validar {
    ...
    public static void usuario(Aluno aluno) throws StringVaziaException,NumeroForaDoIntervaloException,IllegalArgumentException{
        if(aluno == null){
